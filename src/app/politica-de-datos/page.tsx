...
export const metadata: Metadata = {
  ...
  description:
    'Política de tratamiento de datos personales de Kreditools, conforme a la Ley 1581 de 2012 y su normativa reglamentaria en Colombia. Conoce qué datos recopilamos, para qué los usamos y cómo ejercer tus derechos.',
...
const secciones: Array<{ titulo: string; contenido: string[] }> = [
  {
    ...
    contenido: [
      ...
      `En esta política se describen los datos personales que Kreditools recopila, las finalidades de su tratamiento, los derechos que asisten a los titulares y el procedimiento para ejercerlos, en cumplimiento de lo dispuesto por la Ley 1581 de 2012, el Decreto 1377 de 2013 y las demás normas que los modifiquen o complementen.`,
    ],
  },
  {
  ...
  },
  {
    ...
    contenido: [
      'Datos de las personas naturales que se registran en Kreditools (empresarios, administradores, vendedores y demás usuarios de la plataforma):',
      ...
      'La información de clientes y deudores es suministrada por cada usuario de la plataforma, quien se obliga a contar con la autorización previa de los titulares para su tratamiento. Kreditools la procesa únicamente como encargado del tratamiento, en los términos del numeral 8.',
    ],
  },
  {
  ...
  },
  {
    ...
    contenido: [
      `Kreditools, a través de ${datosResponsable.empresa}, se obliga a cumplir los siguientes deberes:`,
  ...
  },
  {
    ...
    contenido: [
      'Kreditools es una plataforma de software como servicio (SaaS). Cada usuario de la plataforma (empresario o prestamista) es el responsable del tratamiento de los datos personales de sus propios clientes y deudores, y Kreditools actúa como encargado del tratamiento respecto de esos datos.',
      'En consecuencia:',
      ...
      '• Kreditools procesará los datos de los clientes y deudores únicamente para la prestación del servicio contratado y siguiendo las instrucciones del responsable.',
  ...
  },
  {
    ...
    contenido: [
      'Kreditools adopta las siguientes medidas técnicas, humanas y administrativas para proteger los datos personales:',
  ...
  },
  {
    ...
    contenido: [
      ...
      'Esta política podrá ser actualizada o modificada por Kreditools. Las modificaciones sustanciales serán publicadas en este sitio y, cuando sea procedente, notificadas a los titulares por los canales disponibles antes de su entrada en vigencia.',
    ],
  },
  {
    titulo: '13. Aceptación',
    contenido: [
      'El registro y uso de la plataforma Kreditools implica la aceptación expresa e informada de la presente Política de Tratamiento de Datos Personales, así como de los Términos y Condiciones del servicio.',
    ],
  },
];
